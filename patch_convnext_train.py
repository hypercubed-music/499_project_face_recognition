...
df_train = keras.preprocessing.image_dataset_from_directory(VGG_DATA_PATH, image_size=input_size[:2], validation_split=0.25, seed=42, subset='training', batch_size=256)
df_val = keras.preprocessing.image_dataset_from_directory(VGG_DATA_PATH, image_size=input_size[:2], validation_split=0.25, seed=42, subset='validation', batch_size=256)
...
checkpoint_callback = keras.callbacks.ModelCheckpoint(
    "/home/jovyan/499_project/patch_conv_pretrained_checkpoint",
...
logger_callback = keras.callbacks.CSVLogger('./train_log_pcnn_pretrained.csv', separator=",", append=False)
